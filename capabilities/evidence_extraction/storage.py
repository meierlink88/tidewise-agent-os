...
from capabilities.evidence_extraction.models import EvidenceCheckpoint, PreparedRawDocument
from capabilities.raw_collection.buffer import artifact_root as collector_artifact_root
